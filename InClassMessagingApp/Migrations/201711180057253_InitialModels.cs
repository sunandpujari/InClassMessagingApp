        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    SurveyUserId = c.String(nullable: false, maxLength: 128),
                    SurveyQuestionId = c.Int(nullable: false),
                    ResponseText = c.String(),
                })
                .PrimaryKey(t => t.SurveyResponseId)
                .ForeignKey("dbo.SurveyUsers", t => t.SurveyUserId)
                .ForeignKey("dbo.SurveyQuestions", t => t.SurveyQuestionId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        SurveyUserId = c.String(nullable: false, maxLength: 128),
                        isCompletedSurvey = c.Boolean(nullable: false),
                        CurrentQuestion = c.Int(nullable: false),
                        CurrentIteration = c.Int(nullable: false),
                    })
